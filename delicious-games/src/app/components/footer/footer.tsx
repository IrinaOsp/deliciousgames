...
export default function Footer() {
  return (
    <footer className="w-screen bg-zinc-100">
      <div className="flex lg:flex-nowrap container mx-0 pt-[30px] px-5 pb-[10px] lg:mx-auto justify-between items-start lg:min-w-max lg:max-w-7xl lg:gap-5 ">
        ...
        <div className="flex gap-[10px]">
          <Link
            ...
            className="flex justify-center items-center bg-sky-800 size-10 rounded-full text-xl"
          >
